...
If you \n\n\
\t-> INSTALLED RELION YOURSELF: if you e.g. specified -DHIP_ARCH=50\n\
\t   and are trying ot run on a compute 3.5 GPU (-DHIP_ARCH=3.5), \n\
\t   this may happen.\n\n\
...
\t   en.wikipedia.org/wiki/HIP#Version_features_and_specifications\n\n\
